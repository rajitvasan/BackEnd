...
public class CategoryTestCase 
{
	...
	public void saveCategory()
	{
		...
		c.setName("Casual Shoes1");
		c.setDescription("Fashionable Formal Shoes");
		assertTrue("Problem in Adding Category",categoryDAO.saveCategory(c));
	}
	...
	{
		String description = "Fashionable and Affordable Casual shoes";
		Category c = categoryDAO.getCategoryByName("Casual Shoes");
		if(c != null)
		{
